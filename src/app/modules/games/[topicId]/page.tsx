...
export default function GamesTopicPage({ params }: { params: Promise<{ topicId: string }> }) {
  ...
  const selectedTopic = topicContent[topicId as keyof typeof topicContent] ?? topicContent["operasi-hitung"];
    ...
    <div className="min-h-screen bg-white pb-32 overflow-y-auto">
      <header className="h-16 border-b flex items-center justify-between px-6 sticky top-0 bg-white z-40">
        ...
        <div className="flex items-center gap-3">
          <Badge className="bg-orange-500">{selectedTopic.badge}</Badge>
      ...
      <main className="container mx-auto px-6 py-8 max-w-4xl">
        <div className="space-y-8">
          <div className="space-y-2">
            <h1 className="text-3xl sm:text-4xl font-headline font-bold text-orange-700">{selectedTopic.title}</h1>
