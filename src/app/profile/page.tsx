...
import { LogOut, Settings, Award, History, ShieldCheck, Mail, Loader2, Star, Trophy } from "lucide-react";
  ...
  return (
    <div className="pt-20 pb-24 px-4 space-y-6">
      ...
      <div className="space-y-3">
        <Button variant="outline" className="w-full justify-start h-14 rounded-2xl gap-4 border-slate-100 text-sm font-medium">
          <History className="h-5 w-5 text-slate-400" /> Riwayat Pembelajaran
        </Button>
        <Button 
          variant="ghost" 
          onClick={handleLogout}
          className="w-full justify-start h-14 rounded-2xl gap-4 text-destructive hover:bg-destructive/5 text-sm font-medium"
        >
